...
const DocsAndAmountFom = (doc : DocsAndAmountFomProps) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <TextInput
        style={styles.input}
        placeholder="2314 - 1341 - 4362 - 1234"
        placeholderTextColor="#ddd"
        editable={true} // to make it look like a display-only field
      /> */}
      ...
      <View style={styles.row}>
        ...
        {/* <View style={styles.cvvContainer}> */}
          ...
          <Input placeholder={`${doc.dueDate.getDate()}/${doc.dueDate.getMonth() + 1}/${doc.dueDate.getFullYear()}`} 
          value={`${doc.dueDate.getDate()}/${doc.dueDate.getMonth() + 1}/${doc.dueDate.getFullYear()}`} 
          onChangeText={()=>{}} 
            /> */}
